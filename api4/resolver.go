...
// objectType is used to categorize objects
...
const (
	channelMemberType objectType = "channelMember"
)
...
func (r *resolver) Channels(ctx context.Context, args struct {
	...
	// This can lead to a possibly large number of channels if teamID is empty,
	// but graphQL doesn't have mature support for streaming APIs. defer has just
	// been announced.
	channels, appErr := c.App.GetChannelsForTeamForUser(args.TeamID, args.UserID, &model.ChannelSearchOpts{
